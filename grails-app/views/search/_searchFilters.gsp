	...
	<div id="search-filters" class="container">
		<div class="row filters">
			<div class="filter-wrapper">
				<div class="col-md-1">
						<button type="button" class="dropdown-filter-btn filter"><i>Filters:</i></button>
					<!-- /.button group -->
				</div>
				<div class="col-md-11">
						...
						<div class="button-group">
							...
							<g:hiddenField name="travel" class="filter-travel-input" />
				   			<ul class="dropdown-menu">
								...
								<g:submitToRemote class="btn btn-default filter-search-btn" url="[controller:'search', action:'filter']" update="search-results" value="Filter"/>
		          			</ul>
						</div>
						<!-- /.button group -->
					</div>
					...
					<div class="col-md-4 cosmetics-filter">
						<div class="button-group dropdown-scroll">
							...
							<g:submitToRemote class="btn btn-default filter-search-btn fixed-btn" url="[controller:'search', action:'filter']" update="search-results" value="Filter"/>
		        		</div>
						<!-- /.button group -->
					</div>
					<!-- /.col -->
