class UrlMappings {
	...
	static mappings = {
		...
		"/profile/uploadProfilePictureFromSettings" (controller: "profile", action: "uploadProfilePictureFromSettings")
		"/profile/uploadCoverPictureFromSettings" (controller: "profile", action: "uploadCoverPictureFromSettings")
